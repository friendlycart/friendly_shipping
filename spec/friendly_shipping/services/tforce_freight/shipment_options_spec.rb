...
RSpec.describe FriendlyShipping::Services::TForceFreight::ShipmentOptions do
  ...
  describe 'structure options' do
    ...
    context 'if no structure options are given' do
      ...
      it "returns an instance of the structure options class" do
        expect(subject.options_for_structure(structure_1)).to be_a(FriendlyShipping::Services::TForceFreight::StructureOptions)
      end
    end
  end
end
