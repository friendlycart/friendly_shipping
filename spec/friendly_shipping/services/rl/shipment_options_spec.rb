...
RSpec.describe FriendlyShipping::Services::RL::ShipmentOptions do
  ...
  describe 'structure options' do
    ...
    context 'if no structure options are given' do
      ...
      it "returns an instance of the structure options class" do
        expect(subject.options_for_structure(structure_1)).to be_a(FriendlyShipping::Services::RL::StructureOptions)
      end
    end
  end
end
